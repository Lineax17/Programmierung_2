...
public class ObstacleType3 extends CollidingGameObject implements ShiftableGameObject, ActivatableGameObject<XWing> {
    /**
     ...
     * @see GamePlayManager
     */
    public ObstacleType3(GameView gameView, GamePlayManager gamePlayManager) {
    ...
    public void addToCanvas() {
        gameView.addImageToCanvas("obstacle_type_3.png", position.getX(), position.getY(), 2.0, rotation);
    }
