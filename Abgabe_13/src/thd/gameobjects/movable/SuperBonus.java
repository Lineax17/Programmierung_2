...
public class SuperBonus extends CollidingGameObject implements ActivatableGameObject<XWing>, ShiftableGameObject {
     ...
     * @see GamePlayManager
     */
    public SuperBonus(GameView gameView, GamePlayManager gamePlayManager) {
    ...
    public void reactToCollisionWith(CollidingGameObject other) {
        if (other instanceof XWing) {
            ...
            gamePlayManager.addPoints(10000);
        }
    }
    ...
    public void addToCanvas() {
        gameView.addImageToCanvas("super_bonus.png", position.getX(), position.getY(), 2.0, rotation);
